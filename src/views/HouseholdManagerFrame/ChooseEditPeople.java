...
import controllers.HoKhauManagerController.ChooseEditPeopleController;

public class ChooseEditPeople extends javax.swing.JFrame {

	private static final long serialVersionUID = 1L;
	private NhanKhauBean nhanKhauBean;
    private NhanKhauBean nhanKhauBeanTemp;
    private JFrame parentJFrame;
    private final ChooseEditPeopleController controller;
    ...
    public ChooseEditPeople(NhanKhauBean nhanKhauBean, JFrame parentJframe) {
        ...
        controller = new ChooseEditPeopleController(this.nhanKhauBeanTemp, searchJtf, selectedJtf, tableJpn);
    ...
    private void confirmBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        this.parentJFrame.setEnabled(true);
        EditHouseholdFrame suaHoKhau = (EditHouseholdFrame)this.parentJFrame;
        suaHoKhau.setDataChuHo();
        dispose();
    }
